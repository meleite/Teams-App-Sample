...
/**
 * Implementation of Snip configuration page
 */
export const SnipTabConfig = () => {
    ...
    const onSaveHandler = (saveEvent: pages.config.SaveEvent) => {
        ...
        pages.config.setConfig({
            contentUrl: host + "/snipTab/?name={loginHint}&tenant={tid}&group={groupId}&theme={theme}",
            websiteUrl: host + "/snipTab/?name={loginHint}&tenant={tid}&group={groupId}&theme={theme}",
            suggestedDisplayName: "Snip",
            removeUrl: host + "/snipTab/remove.html?theme={theme}",
